...
import jameshigashiyama.com.ribbit.adapters.SectionsPagerAdapter;
...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected DialogInterface.OnClickListener mDialogListener =new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                ...
                case 3: // chose vid
                    ...
                    Toast.makeText(MainActivity.this,
                            getString(R.string.video_size_request),
                            Toast.LENGTH_LONG).show();
        ...
        private Uri getOutputMediaFileUri(int mediaType) {
            // to be safe, check External storage is mounted.
            if (isExternalStorageAvailable()) {
                String appName = MainActivity.this.getString(R.string.app_name);

                // get Uri - 1. get exTstorage directory
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
                ...
                if (requestCode == PICK_VIDEO_REQUEST) {
                    ...
                    //ALWAYS put a finally bock to prevent memory leaks, they always get executed
                    finally {
                        try {
                            inputStream.close();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // you need to address this in the menu_main.xml
